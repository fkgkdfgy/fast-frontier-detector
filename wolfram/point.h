...
namespace mre {
  ...
  Point(const Point& p) : point2d<double>(p.x, p.y) {};
    ...
    /* operator carmen_point_t() const { carmen_point_t pt; pt.x = x; pt.y = y; return pt;} */
    /* Point& operator= (const carmen_point_t& pt) { x=pt.x; y=pt.y; return *this;} */
  };
  ...
  OrientedPoint(const OrientedPoint& p) : orientedpoint2d<double,double>(p.x, p.y, p.theta) {};
    ...
    /* operator carmen_point_t() const { carmen_point_t pt; pt.x = x; pt.y = y; pt.theta=theta; return pt;} */
    /* OrientedPoint& operator= (const carmen_point_t& pt) { x=pt.x; y=pt.y; theta=pt.theta; return *this;} */
